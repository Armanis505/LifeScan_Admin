      ...
      >
        <div className="fixed inset-0 flex w-screen items-center justify-end mb-10 p-8">
          <DialogPanel className="max-w-lg space-y-4 border bg-slate-700 text-slate-200 p-5 rounded-2xl">
            ...
            <Description><strong>Número de Control: </strong>{nc}</Description>
            <Description><strong>Nombre: </strong>{name}</Description>
            <Description><strong>Institución: </strong>{institution}</Description>
            <Description><strong>Rol: </strong>{role}</Description>
            <p>Tingarrerra.</p>
          </DialogPanel>
        </div>
      </Dialog>
